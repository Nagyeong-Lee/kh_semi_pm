			...
			<ul class="nav nav-tabs">
				...
				<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false" style="color: black;">게시판관리</a>
					<ul class="dropdown-menu">
						...
						<li id="commentComplainOutputLi"><a class="dropdown-item" href="/commentComplainOutput.manager"> <strong>신고댓글조회</strong>
						</a></li>
					</ul></li>
			</ul>
		</div>
		<div class="main">
			<div class="">
				...
				<div class="contentTitles">
					...
					<div class="contentTitle" style="width: 9%;">댓글번호</div>
					<div class="contentTitle" style="width: 12%;">댓글작성자아이디</div>
					<div class="contentTitle" style="width: 12%;">댓글작성자닉네임</div>
					<div class="contentTitle" style="width: 38%;">댓글내용</div>
				...
				<c:forEach var="i" items="${list}">
					<div class="contents">
						<div class="content" style="width: 5%;">${i.bcmcp_seq}</div>
						<div class="content" style="width: 10%;">${i.bcmcp_complainer}</div>
						<div class="content" style="width: 7%;">${i.formedDate}</div>
						<div class="content" style="width: 9%;">${i.bcm_seq}</div>
						<div class="content" style="width: 12%;">${i.bcm_writer_id}</div>
						<div class="content" style="width: 12%;">${i.bcm_writer_nn}</div>
						<div class="content" style="width: 38%;">${i.bcm_content}</div>
						<div class="content" style="width: 7%;">
							<button type="button" id="${i.bcmcp_seq}">삭제</button>
						</div>
					</div>
					<script>
					$(function() {
						$("#${i.bcmcp_seq}").on("click", function() {
							if (confirm(${i.bcm_seq}+"번의 댓글을 삭제하시겠습니까?")) {
								 location.href="/commentComplainDelete.manager?bcm_seq="+${i.bcm_seq}
								 location.href="/commentComplainTableDelete.manager?bcmcp_seq="+${i.bcmcp_seq}
								alert("삭제되었습니다.");
							} else {
								alert("취소되었습니다.");
							}
